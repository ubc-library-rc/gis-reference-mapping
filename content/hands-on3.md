...
As they are, the layers aren't particularly aesthetic, nor is foreground adequately differentiated from background. This page will guide you modifying your layers' symbology to create a more polished map, as well as note some considerations for mapping for academic publication. 
...
<!-- 
color
- dark either background or foreground but not both
chose contrasting colors, even if in black and white
don't go too light as when printed, might be not decernable. this goes for lines as well that are too thin or text that is too small. 
...
- [Coloring for Colorblindness](https://davidmathlogic.com/colorblind/#%23D81B60-%231E88E5-%23FFC107-%23004D40) will help you design colorblind-friendly palettes. 

lines
- remove outlines from background layers
- add light outline to provinces if all one color 

transparency
- lightens as well
- turn back on indigenous territories

lettering size
-  for labels (this will come in in map configuration more)
- also min max 7pt min. 

While much more can be done with the aesthetics of your map in -- inskcape illustrator, this is plenty to get you started making simple reference maps to accompnay your academic publications. 
...
To Do
{: .label .label-green }
Take 10 minutes --> change symbology of each layer 
